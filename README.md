...
Backtracking: Якщо в поточної вершини немає доступних ребер (зайшли в глухий кут), переносимо її зі stack у фінальний список circuit. Це означає, що всі шляхи з цієї точки вже пройдені.
